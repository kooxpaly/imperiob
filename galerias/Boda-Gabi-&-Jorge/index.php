...
<body>
  ...
  <section id="bodaGB" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Bienvenidos a <span>la galeria de Gabi & Jorge</span></h1>
        ...
        <?php 
              ...
              for($i = 0; $i < count($nuevo['archivo']);$i++){ ?>
                <div class="col-lg-3 col-md-4">
                  <div class="gallery-item" style="width: 100%;height: 100%;">
                    <a href="<?php echo $nuevo['archivo'][$i] ?>" class="gallery-lightbox" data-gall="gallery-item">
                      <img src="<?php echo $nuevo['archivo'][$i]; ?>" alt="" class="img-fluid" style="object-fit: cover;width: 100%;height: 100%;">
                    </a>
                  </div>
                </div>
              <?php } ?>
