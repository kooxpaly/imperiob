							...
							<table role='presentation' style='width:100%;border-collapse:collapse;border:0;border-spacing:0;'>
								<tr>
									<td style='padding:0 0 36px 0;color:#153643;'>
										<h1 style='font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;'>Agendar cita</h1>
										<p style='margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;'>
                                            Hola ".$nombre.", con mucho gusto agendamos su cita para visitar nuestro shoow room, 
                                            esta queda agendada <br> 
                                            para el día: ".$fecha.", <br> 
                                            a las: ".$hora.", <br> 
                                            con un total de: ".$personas." visitante(s), <br> 
                                            usted nos comenta que: <br> 
                                            ".$comentarios."<br> 
                                            Su numero de contacto es: ".$telefono."</p>
...
try {
    ...
    $mail->addCC($correo);
    $mail->Subject = "Agendar una cita o visita";
    $mail->Body = $mensaje;
