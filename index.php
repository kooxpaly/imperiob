...
<head>
  ...
  <title>Imperio B | HOME </title>
  <meta content="Eventos Imperio cuida cada detalle para ese día especial, te ofrece una diversidad de servicios para cubrir tu evento, resaltando la originalidad, elegancia" name="description">
  <meta content="Aforo, Asistentes, Atril, Azafato o azafato de eventos, Break, Briefing, Cartel, Catering, Cena de gala, Ceremonia, Ceremonial, Check-list, Cóctel, Comité, Conferencia, Congreso, Delivery Team, DMC (Destination Management Company), Equipo de producción, Escaleta, Event Planner, Exposición, Expositor, Factura pro-forma, Hospitalidad, Mampara, Mantenedor, Merchandising, Mesa redonda, Moderador, Plano del evento, Programación, Scaffolder o montador, Showroom, Staff, Sitting, Stand, Team Building, Timing, Vino de honor, Welcome party, Workshop, banqueta en Mérida, banqueteria, banquetes Mérida, Banquetes riviera maya, banquetes en la peninsula de Yucatán, organizadora de eventos, Riviera maya, Bodas en riviera maya, XV en hoteles, XV años en Riviera maya, Banquetes para XV años, XV AÑOS, XV, Bodas, graduación, bodas de en sueño" name="keywords">
  <meta name="robots" content="index, follow">
  <meta name="author" content="Banquetera Imperio B">
  <link rel="canonical" href="https://banqueteraimperio.com/">
  <!-- Favicons -->
...
<body>
    ...
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="languages d-none d-md-flex align-items-center">
        <ul>
          ...
          <li><a href=""><i class="fab fa-tiktok"></a></i></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <a href="#book-a-table" class="book-a-table-btn scrollto d-none d-lg-flex">Agenda una cita</a>
  ...
  <main id="main">
    ...
    <!-- <section id="menu" class="menu section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Paquetes</h2>
          <p>Consulta nuestra lista de paquetes</p>
        </div>
    ...
    <!-- <section id="specials" class="specials">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Consulta nuestra especialidades</p>
        </div>
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="includes/agendar.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          <div class="row">
            <div class="col-lg-4 col-md-6 form-group">
              <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Nombre completo" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
              <input type="text" class="form-control" name="telefono" id="telefono" placeholder="Teléfono" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="date" name="fecha" class="form-control" id="fecha" placeholder="Fecha" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="text" class="form-control" name="hora" id="hora" placeholder="Hora" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
            <div class="col-lg-4 col-md-6 form-group mt-3">
              <input type="number" class="form-control" name="personas" id="personas" placeholder="# de personas" data-rule="minlen:1" data-msg="Please enter at least 1 chars">
              <div class="validate"></div>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="sent-message">Su solicitud de cita fue enviada. Le devolveremos la llamada o le enviaremos un correo electrónico para confirmar su cita. ¡Muchas Gracias!</div>
          </div>
    ...
    <!-- <section id="testimonials" class="testimonials section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Testimonios</h2>
          <p>Que es lo que dicen de nosotros</p>
        </div>
    ...
    <section id="gallery" class="gallery">
      ...
      <div class="container-fluid" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/gallery-13.jpg" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/gallery-14.jpg" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/gallery-15.jpg" class="gallery-lightbox" data-gall="gallery-item">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="assets/img/gallery/gallery-16.jpg" class="gallery-lightbox" data-gall="gallery-item">
    ...
    <section id="contact" class="contact">
      ...
      <div data-aos="fade-up">
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7449.866134130911!2d-89.65044944047864!3d20.9953199847341!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f5673881762bffd%3A0xfbae26da82af2ebf!2sImperio%20Rentadora%20Y%20Decorador%20Para%20Eventos!5e0!3m2!1ses-419!2smx!4v1651250160759!5m2!1ses-419!2smx"  frameborder="0" loading="lazy" referrerpolicy="no-referrer-when-downgrade" allowfullscreen ></iframe>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Correo:</h4>
                <p>contacto@banqueteraimperio.com</p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="includes/contacto.php" method="post" role="form" class="php-email-form">
              <div class="row">
              ...
              <div class="form-group mt-3">
                <textarea class="form-control" name="comentarios" rows="8" placeholder="Mensaje" required></textarea>
              </div>
              <div class="my-3">
                <div class="loading">Cargando</div>
                <div class="error-message"></div>
                <div class="sent-message">Su mensaje se envio correctamente. ¡Muchas Gracias!</div>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Terminos de nuestros servicios</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Bodas</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">XV Años</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Graduaciones</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Sesion de fotos</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Hacienda</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Hotel</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Local</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Iglesias</a></li>
            </ul>
          </div>
